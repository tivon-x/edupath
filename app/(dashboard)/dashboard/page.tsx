                ...
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="grid gap-0.5">
                      <CardTitle className="text-sm font-medium">"埋头猛冲的学术达人"</CardTitle>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="grid gap-0.5">
                      <CardTitle className="text-sm font-medium">"技能超强的就业人才"</CardTitle>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-xs bg-primary-100 text-primary-500 px-2 py-0.5 rounded-full">3.17</span>
